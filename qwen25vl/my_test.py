...
Output Format:
<<<
Please provide a full reasoning process first.
Your final answer must follow this exact format (including "Answer:" and yes or no):
**Answer:**
...
def main():
    output_dir = f'./results-cot-cross_res_fuse_{INJECTION_LAYER}/qwen7b_wo_mean/{DATA_NAME}'
